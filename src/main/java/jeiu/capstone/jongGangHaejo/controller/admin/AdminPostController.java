...
public class AdminPostController {
    ...
    public ResponseEntity<Map<String, String>> createPost(
        ...
        adminPostService.createPost(postCreateDto, files);
    ...
    public ResponseEntity<Map<String, String>> updatePost(
        ...
        adminPostService.updatePost(postId, postUpdateDto, files);
    ...
    public PostUploadExceptionDto getPost(@PathVariable(name = "postId") Long id) {
        Post post = adminPostService.getSinglePost(id); //게시물 불러오기
